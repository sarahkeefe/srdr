class PopulationCharacteristicDataPoint < ActiveRecord::Base
	...
	PopulationCharacteristicDataPoint.connection.execute "select setval('population_characteristics_data_points_id_seq', (select max(id) + 1 from population_characteristics_data_points));"
